...
export class SentenceTransformersService {
    ...
    async initialize() {
        ...
        try {
            ...
            try {
                ...
                throw new SentenceTransformersError('Transformers library not found. Install it with: npm install @xenova/transformers\n' +
            ...
            throw new SentenceTransformersError(`Failed to initialize model: ${error instanceof Error ? error.message : 'Unknown error'}`, error);
        }
    }
    /**
    ...
    async generateEmbedding(text) {
        ...
        try {
            ...
            throw new SentenceTransformersError(`Failed to generate embedding: ${error instanceof Error ? error.message : 'Unknown error'}`, error);
        }
    }
    /**
    ...
    async generateBatchEmbeddings(texts) {
        try {
            ...
            throw new SentenceTransformersError(`Failed to generate batch embeddings: ${error instanceof Error ? error.message : 'Unknown error'}`, error);
        }
    }
    /**
     * Clear cache
 ...
 */
export function createSentenceTransformersService(config) {
    return new SentenceTransformersService(config);
}
//# sourceMappingURL=sentence-transformers.js.map
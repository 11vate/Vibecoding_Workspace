 ...
 */
export function discoverRelatedFiles(targetFile, codebase) {
 ...
 */
export function synthesizeContext(patterns, relatedFiles, dependencies) {
    return {
        patterns,
        relatedFiles,
        dependencies,
 ...
 */
export function prioritizeContext(context) {
...
//# sourceMappingURL=layer-13-context-retrieval.js.map
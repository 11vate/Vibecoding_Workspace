 ...
 */
export function getAttributionTemplate(licenseType) {
    const templates = ASSET_SOURCING.documentation.attributionTemplates;
    return templates[licenseType] || templates.custom;
}
/**
 * Check if license allows commercial use
 */
export function allowsCommercialUse(licenseType) {
    const license = ASSET_SOURCING.licenses[licenseType];
    return license?.commercialUse ?? false;
}
//# sourceMappingURL=layer-33-asset-sourcing.js.map
    ...
    codeQuality: {
        readability: {
            ...
            score: (factors) => {
                ...
                return (factors.namingClarity * 0.3 +
        ...
        maintainability: {
            ...
            score: (factors) => {
                return ((1 - factors.duplication) * 0.3 +
        ...
        performance: {
            ...
            score: (factors) => {
                return ((1 - factors.rerenders) * 0.3 +
 ...
 */
export function makeArchitectureDecision(question, context) {
 ...
 */
export function assessCodeQuality(code) {
...
//# sourceMappingURL=layer-11-architecture-intelligence.js.map
...
export const REASONING_PROTOCOL = {
    ...
    treeOfThought: {
        ...
        evaluate: {
            ...
            calculateOverallScore: (scores) => {
                return (scores.constraintAlignment * 0.4 +
                    (1 - scores.risk) * 0.2 +
    ...
    confidenceScoring: {
        ...
        calculate: (scores) => {
            return (scores.requirementClarity * 0.3 +
 ...
 */
export function assessComplexity(request, affectsLockedSystems, requiresArchitecture, scope) {
 ...
 */
export function generateReasoningTrace(complexity, request, context) {
    const traces = [];
 ...
 */
export function performConsistencyChecks(proposedChange, relevantLayers) {
...
//# sourceMappingURL=layer-9-reasoning-protocol.js.map
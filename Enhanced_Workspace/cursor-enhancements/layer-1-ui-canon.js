 ...
 */
export function isForbiddenPattern(pattern) {
    return UI_CANON.forbidden.some(forbidden => pattern.toLowerCase().includes(forbidden.toLowerCase()));
}
//# sourceMappingURL=layer-1-ui-canon.js.map
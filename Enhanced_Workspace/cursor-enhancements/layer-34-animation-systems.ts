...
export const ANIMATION_SYSTEMS = {
  ...
  animationTypes: {
    spriteSheet: {
      ...
      type: "sprite-sheet" as AnimationType,
    ...
    cssKeyframe: {
      ...
      type: "css-keyframe" as AnimationType,
    ...
    procedural: {
      ...
      type: "procedural" as AnimationType,
  ...
  frameworks: {
    gsap: {
      name: "GSAP" as AnimationFramework,
      ...
      performance: "high" as const,
      bundleSize: "medium" as const,
      learningCurve: "medium" as const
    },
    
    framerMotion: {
      name: "Framer Motion" as AnimationFramework,
    ...
    lottie: {
      name: "Lottie" as AnimationFramework,
      ...
      performance: "high" as const,
      bundleSize: "small" as const,
      learningCurve: "easy" as const
    },
    
    threejs: {
      name: "Three.js" as AnimationFramework,
      ...
      performance: "high" as const,
      bundleSize: "large" as const,
      learningCurve: "hard" as const
    },
    
    phaser: {
      name: "Phaser" as AnimationFramework,
    ...
    css: {
      name: "CSS" as AnimationFramework,
    ...
    canvas: {
      name: "Canvas" as AnimationFramework,
    ...
    custom: {
      name: "Custom" as AnimationFramework,
 ...
 */
export function getAnimationFramework(framework: AnimationFramework): AnimationFrameworkDef | undefined {
  return ANIMATION_SYSTEMS.frameworks[framework.toLowerCase().replace(/\s+/g, "") as keyof typeof ANIMATION_SYSTEMS.frameworks];
}

/**
 * Get animation pattern by name
 */
export function getAnimationPattern(patternName: string): AnimationPattern | undefined {
  const patterns = ANIMATION_SYSTEMS.patterns;
  return (patterns as Record<string, AnimationPattern>)[patternName];
}

/**
 * Recommend animation framework
 */
export function recommendAnimationFramework(useCase: string): AnimationFrameworkDef[] {
  const recommendations: AnimationFrameworkDef[] = [];

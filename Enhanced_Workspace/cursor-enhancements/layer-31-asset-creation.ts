  ...
  aiAssisted: {
    ...
    promptEngineering: {
      ...
      backgroundGeneration: {
        assetType: "background" as AssetType,
      ...
      textureGeneration: {
        assetType: "texture" as AssetType,
 ...
 */
export function getAIPromptTemplate(assetType: AssetType): AIPromptTemplate | undefined {
  const templates = ASSET_CREATION.aiAssisted.promptEngineering;
  return (templates as Record<string, AIPromptTemplate>)[`${assetType}Generation`];
}

/**
 * Generate AI prompt from template
 */
export function generateAIPrompt(template: AIPromptTemplate, variables: Record<string, string>): string {
 ...
 */
export function getProceduralAlgorithm(assetType: AssetType, algorithmName: string): ProceduralAlgorithm | undefined {

 ...
 */
export function checkSecurityVulnerability(code: string, vulnerabilityType: keyof typeof SECURITY_PATTERNS.owaspTop10): boolean {
 ...
 */
export function getSecurityBestPractices(vulnerabilityType: keyof typeof SECURITY_PATTERNS.owaspTop10): string[] {

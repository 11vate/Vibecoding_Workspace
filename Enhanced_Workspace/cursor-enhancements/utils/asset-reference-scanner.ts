 ...
 */
export function scanForAssetReferences(
  code: string,
 ...
 */
function scanPhaserReferences(code: string, lines: string[]): AssetReference[] {
  const references: AssetReference[] = [];
 ...
 */
function scanPixiReferences(code: string, lines: string[]): AssetReference[] {
  const references: AssetReference[] = [];
 ...
 */
function scanGenericReferences(code: string, lines: string[]): AssetReference[] {
  const references: AssetReference[] = [];
 ...
 */
function extractAssetIdFromPath(filePath: string): string | null {
 ...
 */
export function generateAssetSpecsForMissing(missing: MissingAsset[]): AssetSpec[] {
 ...
 * Full scan and check
 */
export async function scanAndCheckAssets(
  code: string,
  registry: AssetRegistry,
  framework?: GameFramework
): Promise<ScanResult> {

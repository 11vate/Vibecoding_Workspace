 ...
 */
export function analyzeSpriteSheet(imageData, options) {
 ...
 */
export function generateCodeBindings(spriteSheet, framework) {
 ...
 */
export function performMultimodalReasoning(inputs, query) {

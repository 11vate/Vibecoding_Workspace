 ...
 */
export function getComponentPattern(name) {
    return COMPONENT_PATTERNS[name];
}
/**
 * Get styles for component state
 */
export function getComponentStateStyles(component, state) {
    const pattern = COMPONENT_PATTERNS[component];
    return pattern.states[state]?.styles || {};
}
//# sourceMappingURL=layer-16-component-patterns.js.map
 ...
 */
export function getArchitecturePattern(category, patternName) {
 ...
 */
export function getDDDConcept(conceptName) {
    return ARCHITECTURE_PATTERNS.ddd[conceptName];
}
//# sourceMappingURL=layer-26-architecture-patterns.js.map
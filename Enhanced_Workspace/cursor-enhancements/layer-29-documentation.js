...
**Parameters:**
- `, id
        } ` (path, required): User ID (UUID)

**Query Parameters:**
- `, includeDeleted
    } ` (boolean, optional): Include soft-deleted users (default: false)
...
\`\`\`
`
}, requestResponseExamples, errorScenarios, authentication;
/**
...
architectureDocumentation: {
    ...
    systemDiagrams: {
        ...
        [
            ...
            tools;
        ["Mermaid", "PlantUML", "Draw.io", "diagrams.net"],
            bestPractices;
        [
 ...
 */
export function getDocumentationPattern(type, patternName) {
 ...
 */
export function validateJSDoc(comment) {
    const issues = [];
    if (!comment.includes('*')) {
...
//# sourceMappingURL=layer-29-documentation.js.map